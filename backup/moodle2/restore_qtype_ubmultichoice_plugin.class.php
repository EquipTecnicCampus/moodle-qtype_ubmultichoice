 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_ubmultichoice_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff
        $elename = 'ubmultichoice';
        // we used get_recommended_name() so this works
        $elepath = $this->get_pathfor('/ubmultichoice');
    ...
    /**
     * Process the qtype/ubmultichoice element
     */
    public function process_ubmultichoice($data) {
        global $DB;
        ...
        if ($questioncreated) {
            ...
            // Insert record
            $newitemid = $DB->insert_record('question_ubmultichoice', $data);
            // Create mapping (needed for decoding links)
            $this->set_mapping('question_ubmultichoice', $oldid, $newitemid);
    ...
    public static function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('question_ubmultichoice',
                $fields, 'question_ubmultichoice');
