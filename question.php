 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_ubmultichoice_base extends question_graded_automatically {
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ubmultichoice_single_question extends qtype_ubmultichoice_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_ubmultichoice', 'single');
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ubmultichoice_multi_question extends qtype_ubmultichoice_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_ubmultichoice', 'multi');
    }
