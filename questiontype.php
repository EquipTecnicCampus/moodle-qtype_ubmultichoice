 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ubmultichoice extends question_type {
    public function get_question_options($question) {
        global $DB, $OUTPUT;
        $question->options = $DB->get_record('question_ubmultichoice',
    ...
    public function save_question_options($question) {
        ...
        $options = $DB->get_record('question_ubmultichoice', array('question' => $question->id));
        if (!$options) {
            ...
            $options->id = $DB->insert_record('question_ubmultichoice', $options);
        }
        ...
        $DB->update_record('question_ubmultichoice', $options);
    ...
    protected function make_question_instance($questiondata) {
        ...
        if ($questiondata->options->single) {
            $class = 'qtype_ubmultichoice_single_question';
        } else {
            $class = 'qtype_ubmultichoice_multi_question';
        }
        return new $class();
    }
    ...
    protected function initialise_question_instance(question_definition $question, $questiondata) {
        ...
        if (!empty($questiondata->options->layout)) {
            ...
            $question->layout = qtype_ubmultichoice_single_question::LAYOUT_VERTICAL;
        }
    ...
    public function delete_question($questionid, $contextid) {
        global $DB;
        $DB->delete_records('question_ubmultichoice', array('question' => $questionid));
