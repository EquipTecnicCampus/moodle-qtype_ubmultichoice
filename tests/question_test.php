 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ubmultichoice_single_question_test extends advanced_testcase {

    public function test_get_expected_data() {
        $question = test_question_maker::make_a_ubmultichoice_single_question();
    ...
    public function test_grading_rounding_three_right() {
        question_bank::load_question_definition_classes('ubmultichoice');
        $mc = new qtype_ubmultichoice_multi_question();
        test_question_maker::initialise_a_question($mc);
        $mc->name = 'Odd numbers';
        $mc->questiontext = 'Which are the odd numbers?';
        $mc->generalfeedback = '1, 3 and 5 are the odd numbers.';
        $mc->qtype = question_bank::get_qtype('ubmultichoice');
    ...
    public function test_summarise_response() {
        $mc = test_question_maker::make_a_ubmultichoice_single_question();
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ubmultichoice_multi_question_test extends advanced_testcase {

    public function test_get_expected_data() {
        $question = test_question_maker::make_a_ubmultichoice_multi_question();
        $question->start_attempt(new question_attempt_step(), 1);
    ...
    public function test_summarise_response() {
        $mc = test_question_maker::make_a_ubmultichoice_multi_question();
        $mc->shuffleanswers = false;
        $mc->start_attempt(new question_attempt_step(), 1);
