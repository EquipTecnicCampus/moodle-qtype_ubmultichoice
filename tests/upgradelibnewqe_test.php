 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_ubmultichoice_attempt_upgrader_test extends question_attempt_upgrader_test_base {

    public function test_ubmultichoice_deferredfeedback_history960() {
        $quiz = (object) array(
            'id' => '1',
            'course' => '3',
            'name' => 'Test quiz 1',
    ...
    public function test_ubmultichoice_deferredfeedback_history0() {
        $quiz = (object) array(
            'id' => '8',
            'course' => '1095',
    ...
    public function test_ubmultichoice_deferredfeedback_history60() {
        $quiz = (object) array(
            'id' => '13',
            'course' => '1416',
    ...
    public function test_ubmultichoice_deferredfeedback_history6220() {
        $quiz = (object) array(
            'id' => '95',
            'course' => '1181',
    ...
    public function test_ubmultichoice_deferredfeedback_missing() {
        $quiz = (object) array(
            'id' => '8',
            'course' => '1095',
            'name' => 'End of course quiz',
...
public function test_ubmultichoice_deferredfeedback_qsession140() {
        $quiz = (object) array(
            'id' => '58',
            'course' => '3420',
            'name' => 'Practice Quiz',
    ...
    public function test_ubmultichoice_deferredfeedback_qsession2018195() {
        $quiz = (object) array(
            'id' => '1832',
            'course' => '4912',
    ...
    public function test_ubmultichoice_deferredfeedback_qsession2653368() {
        $quiz = (object) array(
            'id' => '3273',
            'course' => '5862',
    ...
    public function test_ubmultichoice_deferredfeedback_qsession3131() {
        $quiz = (object) array(
            'id' => '10',
            'course' => '608',
    ...
    public function test_ubmultichoice_deferredfeedback_qsession4307870 () {
        $quiz = (object) array(
            'id' => '4070',
            'course' => '5139',
    ...
    public function test_ubmultichoice_deferredfeedback_qsession49446() {
        $quiz = (object) array(
            'id' => '203',
            'course' => '2359',
            'name' => 'Quiz 1',
    ...
    public function test_ubmultichoice_deferredfeedback_qsession591() {
        $quiz = (object) array(
            'id' => '22',
            'course' => '272',
    ...
    public function test_ubmultichoice_deferredfeedback_qsession594() {
        $quiz = (object) array(
            'id' => '22',
            'course' => '272',
            'name' => 'ICT self-assessment quiz',
